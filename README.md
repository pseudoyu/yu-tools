...
- **Image Smith**，图片压缩工具，刚尝试的一个新工具，很不错，但是作为博客上传来说没有 TinyPNG4Mac 方便，备用
...
- **Plex Media Server**，流媒体管理服务器，可以指定本地目录自动获取元数据进行媒体库管理，后来改为阿里云服务器进行远程访问
...
以上就是我自用的工具箱，花了好几天，把电脑和手机的 App 都彻底整理分类了一遍，随着使用时间越来越长，一直在做减法，也在不断优化自己的使用，希望能够对大家有所参考。
